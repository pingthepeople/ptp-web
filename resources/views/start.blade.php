...
@section('content')
    ...
    <div class="welcome">
        ...
        <ol>
            <li>Search <a href="/bills"><em>All Legislation</em></a> below by number, committee, subject, keyword, etc. Click the <strong>Watch</strong> button to add legislation to your watchlist. You can add or remove items whenever you'd like.</li>
